...
def run_sandbox():
    ...
    # Load rents if they exist, otherwise create an empty table
    ...
    # IMPORT THE SHARED FINANCIAL LOGIC, pointing to 'parcel_calculations' as the source
    financial_ctes = get_financial_filter_ctes(source_table_name="parcel_calculations")

    query = f"""
        WITH
        -- 1. ISOLATE THE 4 TEST NEIGHBORHOODS
        test_nbhds AS (
        ...
        -- 2. FILTER PARCELS FIRST (This drops the dataset from 600k+ to ~40k instantly)
        ...
        -- 3. LOAD REMAINING SPATIAL/ASSESSOR DATA
        ...
        -- ====================================================================================
        -- 💡 IMPORTED FINANCIAL PRO FORMA LOGIC 
        -- ====================================================================================
        {financial_ctes}
        -- ====================================================================================
