# Hardcoded estimates for blended New Construction Rents (Studio, 1BR, 2BR average)
# Source: Zumper & RentCafe 2024 Chicago Market Reports
CHICAGO_NEW_BUILD_RENTS = {
    'LINCOLN PARK': 2800.0,
    'NEAR NORTH SIDE': 2900.0,
    'LOOP': 2900.0,
    'NEAR WEST SIDE': 2800.0,
    'LAKE VIEW': 2400.0,
    'WEST TOWN': 2500.0,
    'LOGAN SQUARE': 2300.0,
    'NORTH CENTER': 2300.0,
    'LINCOLN SQUARE': 2100.0,
    'UPTOWN': 2000.0,
    'EDGEWATER': 1900.0,
    'AVONDALE': 1900.0,
    'HYDE PARK': 2100.0,
    ...
    'AUSTIN': 1400.0,
    'ENGLEWOOD': 1300.0,
    'WASHINGTON PARK': 1500.0
}

# Fallback rent for any neighborhood not explicitly listed above
    ...
    return f"""
        ...
        filtered_parcels AS (
            SELECT center_geom, area_sqft, parcels_combined, zone_class, neighborhood_name, prop_address,
                ...
                -- FIXED LOGIC:
                -- 1. Block Commercial Condos (599) in addition to Residential Condos (299)
                -- 2. If it claims to be a vacant/commercial lot (Age 0), the building value MUST be low. 
                --    (If Age is 0 but the building is worth $1M+, it's a data gap on a real building, not a dirt lot).
